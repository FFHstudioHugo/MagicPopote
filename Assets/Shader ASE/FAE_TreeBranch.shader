    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v)
        	{
				...
				float2 panner341 = ( 0.05 * _Time.y * float2( 1,1 ) + ( ( _WindAmplitudeMultiplier * _WindAmplitude * ( (ase_worldPos).xz * 0.01 ) ) + ( temp_output_60_0 * appendResult249 ) ));
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float temp_output_60_0 = ( ( _WindSpeed * 0.05 ) * 0.0 );
				float2 appendResult249 = (float2(_WindDirection.x , _WindDirection.z));
				float2 panner341 = ( 0.05 * _Time.y * float2( 1,1 ) + ( ( _WindAmplitudeMultiplier * _WindAmplitude * ( (WorldSpacePosition).xz * 0.01 ) ) + ( temp_output_60_0 * appendResult249 ) ));
...
/*ASEBEGIN
Version=16105
-137.6;251.2;1461;830;3352.162;2071.599;2.318209;True;False
Node;AmplifyShaderEditor.CommentaryNode;238;-3972.506,-2089.813;Float;False;2833.298;786.479;Comment;10;5;210;209;59;106;341;102;10;237;99;Leaf wind animation;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;5;-3906.604,-1928.549;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;142;-3998.498,-400.152;Float;False;Global;_TrunkWindSpeed;_TrunkWindSpeed;10;0;Create;True;0;0;False;0;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;239;-3957.72,-1217.98;Float;False;2848.898;709.3215;Comment;2;206;250;Global wind animation;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;211;-3322.042,-2039.813;Float;False;Property;_WindAmplitudeMultiplier;WindAmplitudeMultiplier;8;0;Create;True;0;0;False;0;1;-0.16;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;315;-3291.345,-1955.613;Float;False;Global;_WindAmplitude;_WindAmplitude;12;0;Create;True;0;0;False;0;2;0.85;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;209;-3267.658,-1819.793;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1766.407,-1659.435;Float;False;Property;_MaxWindStrength;MaxWindStrength;5;0;Create;True;0;0;False;0;0.1164738;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;284;-1764.627,-1563.295;Float;False;Global;_WindStrength;_WindStrength;12;0;Create;True;0;0;False;0;1;1.11;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E856CEECFE9991178DF80C353FB2312E20E35624