    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v)
        	{
				...
				float temp_output_60_0 = ( ( _WindSpeed * 0.05 ) * 0.0 );
				float3 appendResult249 = (float3(_WindDirection.x , _WindDirection.y , _WindDirection.z));
				float2 panner341 = ( 0.05 * _Time.y * float2( 1,1 ) + ( ( _WindAmplitudeMultiplier * _WindAmplitude * ( ase_worldPos * 0.01 ) ) + ( temp_output_60_0 * appendResult249 ) ).xy);
				float4 WindVectors99 = tex2Dlod( _WindVectors, float4( panner341, 0, 0.0) );
				float3 appendResult250 = (float3(_WindDirection.x , _WindDirection.y , _WindDirection.z));
				float3 _Vector2 = float3(1,1,1);
				float3 break282 = ( ( (float3( 0,0,0 ) + (sin( ( ( temp_output_60_0 * ( _TrunkWindSpeed / 0.0 ) ) * appendResult250 ) ) - ( float3(-1,-1,-1) + _TrunkWindSwinging )) * (_Vector2 - float3( 0,0,0 )) / (_Vector2 - ( float3(-1,-1,-1) + _TrunkWindSwinging ))) * _TrunkWindWeight ) * v.ase_color.a );
				float3 appendResult283 = (float3(break282.x , 0.0 , break282.z));
				float4 Wind17 = ( ( ( WindVectors99 * v.ase_color.g ) * _MaxWindStrength * _WindStrength ) + float4( appendResult283 , 0.0 ) );
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float temp_output_60_0 = ( ( _WindSpeed * 0.05 ) * 0.0 );
				float3 appendResult249 = (float3(_WindDirection.x , _WindDirection.y , _WindDirection.z));
				float2 panner341 = ( 0.05 * _Time.y * float2( 1,1 ) + ( ( _WindAmplitudeMultiplier * _WindAmplitude * ( WorldSpacePosition * 0.01 ) ) + ( temp_output_60_0 * appendResult249 ) ).xy);
				float4 WindVectors99 = tex2D( _WindVectors, panner341 );
				float4 lerpResult97 = lerp( ( _mAINcoLOR * Color56 ) , WindVectors99 , _WindDebug);
...
/*ASEBEGIN
Version=16105
251.2;848;1461;830;4267.302;1761.222;1.265422;True;False
Node;AmplifyShaderEditor.CommentaryNode;238;-3972.506,-2089.813;Float;False;2833.298;786.479;Comment;10;210;209;59;106;341;102;10;237;99;5;Leaf wind animation;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-3922.506,-1624.636;Float;False;Global;_WindSpeed;_WindSpeed;7;0;Create;True;0;0;False;0;0.3;0.073;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;239;-3957.72,-1217.98;Float;False;2848.898;709.3215;Comment;5;206;250;142;87;249;Global wind animation;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;142;-3906.859,-802.9371;Float;False;Global;_TrunkWindSpeed;_TrunkWindSpeed;10;0;Create;True;0;0;False;0;10;19;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;87;-3907.846,-1227.588;Float;False;Global;_WindDirection;_WindDirection;9;0;Create;True;0;0;False;0;1,0,0,0;-0.9602937,0,-0.2789911,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;315;-3291.345,-1955.613;Float;False;Global;_WindAmplitude;_WindAmplitude;12;0;Create;True;0;0;False;0;2;2.96;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;249;-3064.967,-1186.615;Float;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;211;-3322.042,-2039.813;Float;False;Property;_WindAmplitudeMultiplier;WindAmplitudeMultiplier;8;0;Create;True;0;0;False;0;1;1.55;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;-3197.828,-798.7911;Float;False;Global;_TrunkWindSwinging;_TrunkWindSwinging;10;0;Create;True;0;0;False;0;0;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;248;-2930.195,-149.8801;Float;False;Property;_GradientBrightness;GradientBrightness;9;0;Create;True;0;0;False;0;1;1.05;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;144;-2294.521,-923.9849;Float;False;Global;_TrunkWindWeight;_TrunkWindWeight;10;0;Create;True;0;0;False;0;2;2.31;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;341;-2674.613,-1902.479;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,1;False;1;FLOAT;0.05;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;102;-2542.595,-1778.141;Float;True;Global;_WindVectors;_WindVectors;7;0;Create;True;0;0;False;0;None;6c795dd1d1d319e479e68164001557e8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;99;-2136.922,-1771.871;Float;False;WindVectors;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;213;-2398.831,721.1215;Float;False;Property;_TransmissionColor;Transmission Color;3;0;Create;True;0;0;False;0;1,1,1,0;0.4781763,0.5849056,0.1296723,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;237;-1857.104,-1736.955;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;284;-1764.627,-1563.295;Float;False;Global;_WindStrength;_WindStrength;12;0;Create;True;0;0;False;0;1;0.6384;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-1331.207,-1774.334;Float;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;339;319.3164,-990.36;Float;False;Property;_mAINcoLOR;mAINcoLOR;11;0;Create;True;0;0;False;0;0.2705589,0.6037736,0.3368931,0;0.1580632,0.3018866,0.1885712,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;123;-869.729,-1375.275;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;17;-378.4811,-1378.025;Float;False;Wind;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;98;284.0998,-712.3729;Float;False;99;WindVectors;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;18;624.2745,22.64254;Float;False;17;Wind;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-2409.993,1253.799;Float;False;Property;_AmbientOcclusion;AmbientOcclusion;4;0;Create;True;0;0;False;0;0;0.49;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;254;-89.41714,-236.6956;Float;False;Property;_Smoothness;Smoothness;10;0;Create;True;0;0;False;0;0;0.142;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;333;991.1499,-295.7243;Half;False;True;2;Half;ASEMaterialInspector;0;4;FAE/Tree Branch;1976390536c6c564abb90fe41f6ee334;0;0;Base;11;False;False;False;True;2;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=TreeTransparentCutout=RenderType;Queue=AlphaTest=Queue=0;True;3;0;True;2;5;False;-1;10;False;-1;0;5;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;;0;0;Standard;1;_FinalColorxAlpha;0;11;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;9;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT3;0,0,0;False;10;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=E476F338C68526F83A7989BD75DAD0C14BCA4BEB