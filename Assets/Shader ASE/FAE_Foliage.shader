    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v)
        	{
				...
				float3 GlobalWind84 = ( appendResult583 * _MaxWindStrength * v.ase_color.r * _WindStrength );
				...
				float4 Bending201 = ( v.ase_color.r * -( ( ( normalizeResult184 * float4( appendResult468 , 0.0 ) ) * ( 1.0 - clampResult192 ) ) * _BendingInfluence ) );
				float4 VertexOffset330 = ( float4( GlobalWind84 , 0.0 ) + Bending201 );
				
				float3 lerpResult552 = lerp( v.ase_normal , float3(0,1,0) , _FlatLighting);
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float3 WindVector577 = UnpackNormalmapRGorAG( tex2D( _WindVectors, ( float3( ( ( temp_output_514_0 * 0.05 ) * appendResult518 ) ,  0.0 ) + ( ( WorldSpacePosition * 0.01 ) * _WindAmplitudeMultiplier * _WindAmplitude ) ).xy ), 1.0f );
				float2 break584 = ( ( _GlobalWindMotion * (lerpResult544).x ) + ( _LeafFlutter * (WindVector577).xy ) );
				float3 appendResult583 = (float3(break584.x , 0.0 , break584.y));
				float3 GlobalWind84 = ( appendResult583 * _MaxWindStrength * IN.ase_color.r * _WindStrength );
				float lerpResult271 = lerp( (GlobalWind84).x , 0.0 , ( 1.0 - IN.ase_color.r ));
				...
				float lerpResult151 = lerp( ( pow( max( dotResult141 , 0.0 ) , _TransmissionSize ) * _TransmissionAmount ) , 1 , ( ( 1.0 - IN.ase_color.r ) * 1.52 ));
				...
				float lerpResult557 = lerp( 1.0 , IN.ase_color.r , _AmbientOcclusion);
				...
				float Occlusion = AmbientOcclusion207;
...
/*ASEBEGIN
Version=16105
0.8;0.8;1472;840;2544.158;-2933.06;1.490121;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;319;-3937.326,-3132.458;Float;False;Global;_WindSpeed;_WindSpeed;11;0;Create;True;0;0;False;0;0;0.123;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;516;-3691.352,-2718.526;Float;False;Global;_WindDirection;_WindDirection;9;0;Create;True;0;0;False;0;1,0,0,0;-0.9602937,0,-0.2789911,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;565;-3636.875,-2224.849;Float;False;Property;_WindAmplitudeMultiplier;WindAmplitudeMultiplier;10;0;Create;True;0;0;False;0;10;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;571;-3638.923,-2138.373;Float;False;Global;_WindAmplitude;_WindAmplitude;20;0;Create;True;0;0;False;0;1;1.45;1;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;248;-2550.377,-2800.018;Float;False;Property;_WindSwinging;WindSwinging;6;0;Create;True;0;0;False;0;0;0.31;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;588;-2122.579,-2651.492;Float;False;Property;_LeafFlutter;LeafFlutter;13;0;Create;True;0;0;False;0;0.495;0.73;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1069.807,-2732.127;Float;False;Property;_MaxWindStrength;Max Wind Strength;11;0;Create;True;0;0;False;0;0.126967;0.041;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;385;-1000.576,-2451.538;Float;False;Global;_WindStrength;_WindStrength;19;0;Create;True;0;0;False;0;2;0.66;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;160;-3251.288,1459.145;Float;False;2711.621;557.9603;Subsurface scattering;18;153;152;380;151;149;147;148;146;145;141;143;139;140;138;503;550;596;150;Subsurface color simulation;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector4Node;231;-3149.54,-21.90026;Float;False;Global;_ObstaclePosition;_ObstaclePosition;18;1;[HideInInspector];Create;True;0;0;False;0;0,0,0,0;6.277151,0.0486958,6.527996,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;232;-2770.54,494.1013;Float;False;Global;_BendingRadius;_BendingRadius;14;1;[HideInInspector];Create;True;0;0;False;0;0;1.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;234;-2752.54,198.0997;Float;False;Global;_BendingStrength;_BendingStrength;15;1;[HideInInspector];Create;True;0;0;False;0;0;38;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;101;-1761.713,1083.204;Float;False;Property;_WindTint;WindTint;2;0;Create;True;0;0;False;0;0.1;-0.12;-0.5;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-2757.122,1735.206;Float;False;Property;_TransmissionSize;Transmission Size;4;0;Create;True;0;0;False;0;1;2.6;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;150;-2169.331,1904.778;Float;False;Constant;_TransmissionHeight;TransmissionHeight;12;0;Create;True;0;0;False;0;1.52;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightAttenuation;596;-1968.609,1641.468;Float;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;195;-1833.604,412.4233;Float;False;Property;_BendingInfluence;BendingInfluence;8;0;Create;True;0;0;False;0;0;0.28;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;597;-952.709,3678.119;Float;False;Property;_Color;Color;15;0;Create;True;0;0;False;0;0.1148096,0.5660378,0.1933963,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;551;2933.198,2422.128;Float;False;Property;_FlatLighting;FlatLighting;9;0;Create;True;0;0;False;0;0;0.13;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;113;-2171.473,2528.067;Float;False;Property;_AmbientOcclusion;AmbientOcclusion;3;0;Create;True;0;0;False;0;0;0.831;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;595;3582.728,1201.341;Float;False;Property;_Smoothness;Smoothness;14;0;Create;True;0;0;False;0;0;0.28;0;1;0;1;FLOAT;0
...
WireConnection;589;4;595;0
WireConnection;589;5;208;0
WireConnection;589;6;313;0
WireConnection;589;7;593;0
WireConnection;589;8;331;0
WireConnection;589;10;552;0
ASEEND*/
//CHKSM=FBD20A6E190F7B78CD01E1D14C881C88C12F6A7C