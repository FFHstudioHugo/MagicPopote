    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v)
        	{
				...
				float2 uv127 = v.texcoord1.xyzw.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_41_0 = ( appendResult93 * _TrunkWindWeight * lerp(v.ase_color.a,( uv127.y * 0.01 ),_UseSpeedTreeWind) );
        ...
        Pass
        {
            ...
            VertexOutput ShadowPassVertex(GraphVertexInput v)
        	{
				...
				float3 break94 = (float3( 0,0,0 ) + (sin( ( ( ( ( _WindSpeed * 0.05 ) * _Time.w ) * ( _TrunkWindSpeed / ase_objectScale ) ) * appendResult88 ) ) - ( float3(-1,-1,-1) + _TrunkWindSwinging )) * (_Vector1 - float3( 0,0,0 )) / (_Vector1 - ( float3(-1,-1,-1) + _TrunkWindSwinging )));
				float3 appendResult93 = (float3(break94.x , 0.0 , break94.z));
				float2 uv127 = v.ase_texcoord1 * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_41_0 = ( appendResult93 * _TrunkWindWeight * lerp(v.ase_color.a,( uv127.y * 0.01 ),_UseSpeedTreeWind) );
				float3 Wind111 = temp_output_41_0;
        ...
        Pass
        {
            ...
            VertexOutput vert(GraphVertexInput v)
            {
				...
				float3 break94 = (float3( 0,0,0 ) + (sin( ( ( ( ( _WindSpeed * 0.05 ) * _Time.w ) * ( _TrunkWindSpeed / ase_objectScale ) ) * appendResult88 ) ) - ( float3(-1,-1,-1) + _TrunkWindSwinging )) * (_Vector1 - float3( 0,0,0 )) / (_Vector1 - ( float3(-1,-1,-1) + _TrunkWindSwinging )));
				float3 appendResult93 = (float3(break94.x , 0.0 , break94.z));
				float2 uv127 = v.texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_41_0 = ( appendResult93 * _TrunkWindWeight * lerp(v.ase_color.a,( uv127.y * 0.01 ),_UseSpeedTreeWind) );
				float3 Wind111 = temp_output_41_0;
...
/*ASEBEGIN
Version=16100
6.4;6.4;1131;790;-3.540857;1732.819;4.268511;True;False
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;131;3187.507,-301.7967;Float;False;True;2;Float;ASEMaterialInspector;0;2;FAE/Tree Trunk;1976390536c6c564abb90fe41f6ee334;0;0;Base;11;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;;0;0;Standard;1;_FinalColorxAlpha;0;11;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;9;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT3;0,0,0;False;10;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=3566C05687C41EA2BBF51A0FCD5A82FA9DB90FE4